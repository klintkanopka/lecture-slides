...
- I'm _mostly_ a psychometrician, but I have a background in computational physics and machine learning
- Please call me Klint if you feel comfortable doing so
- This is the third time this course has ever existed, so I'm _very_ interested in feedback
- Email me: [klint.kanopka@nyu.edu](klint.kanopka@nyu.edu)
...
- "Valuable suggestions" include proposed examples, datasets, ways to increase clarity, new topics, and applications
  - If I _plan_ to adopt a suggestion, you'll get extra credit
  - If I _actually_ adopt a suggestion, you'll get acknowledgement in course materials
